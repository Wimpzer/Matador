	...
	public void NewBoard()
	 {
			...
			fields[1] = new Street    (2, "Rødovrevej", 1200, 1000, 50, 250, 750, 2250, 4000, 6000);
			...
			fields[5] = new Shipping  (6, "Shipping - LB Færgerne",2000, 4000, 500, 1000, 2000,4000);
			...
			fields[15] = new Shipping (16, "Shipping - Kalundborg/Århus",2000, 4000, 500, 1000, 2000,4000);	
			...
			fields[23] = new Street   (24, "Østerbrogade", 4400, 3000, 350, 1800, 5000, 14000, 17500, 21000);	
			fields[24] = new Street   (25, "Grønningen", 4800, 3000, 400, 2000, 6000, 15000, 18500, 22000);	
			...
			fields[29] = new Street   (30, "Østergade", 5600, 3000, 500, 2400, 7200, 17000, 20500, 24000);	
			...
			fields[39] = new Street   (40, "Rådhuspladsen)", 8000, 4000, 1000, 4000, 12000, 28000, 34000, 40000);	
